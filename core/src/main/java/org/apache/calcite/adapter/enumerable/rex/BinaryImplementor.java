...
class BinaryImplementor extends AbstractRexCallImplementor {
  ...
  @Override Expression implementSafe(final RexToLixTranslator translator,
    ...
    if (backupMethodName != null) {
      ...
      if (primitive == null || type1 == BigDecimal.class || shouldEquals(type0)
  ...
  private boolean shouldEquals(Type type) {
    return Primitive.isBox(type) && (expressionType == ExpressionType.Equal
