...
class ExtractImplementor extends AbstractRexCallImplementor {
  ...
  @Override Expression implementSafe(final RexToLixTranslator translator,
    ...
    final ConstantExpression timeUnitRangeExpression =
        (ConstantExpression) translator.getLiteral(argValueList.get(0));
    final TimeUnitRange timeUnitRange =
        (TimeUnitRange) timeUnitRangeExpression.value;
