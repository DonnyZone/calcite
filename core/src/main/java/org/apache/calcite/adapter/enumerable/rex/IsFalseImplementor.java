...
class IsFalseImplementor extends AbstractRexCallImplementor {
  ...
  @Override Expression implementSafe(final RexToLixTranslator translator,
    ...
    return Expressions.equal(argValueList.get(0), RexImpTable.FALSE_EXPR);
  }
}

// End IsFalseImplementor.java
