...
class IsNotNullImplementor extends AbstractRexCallImplementor {
  ...
  @Override Expression implementSafe(final RexToLixTranslator translator,
    ...
    return Expressions.notEqual(argValueList.get(0), RexImpTable.NULL_EXPR);
  }
}

// End IsNotNullImplementor.java
