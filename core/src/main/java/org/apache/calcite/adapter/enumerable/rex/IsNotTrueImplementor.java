...
class IsNotTrueImplementor extends AbstractRexCallImplementor {
  ...
  @Override Expression implementSafe(final RexToLixTranslator translator,
    ...
    return Expressions.notEqual(argValueList.get(0), RexImpTable.TRUE_EXPR);
  }
}

// End IsNotTrueImplementor.java
