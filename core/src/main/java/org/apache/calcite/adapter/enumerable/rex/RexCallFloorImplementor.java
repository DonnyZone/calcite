...
class RexCallFloorImplementor extends RexCallMethodNameImplementor {
    ...
    switch (call.getOperands().size()) {
      case 1:
        switch (call.getType().getSqlTypeName()) {
          ...
          default:
            return super.implementNotNull(translator, call, argValueList);
        }
      case 2:
        final Type type;
        ...
        final ConstantExpression tur =
            (ConstantExpression) argValueList.get(1);
...
// End RexCallTimeImplementor.java
