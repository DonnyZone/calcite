...
class RexCallIsFalseImplementor extends RexCallAbstractImplementor {

  RexCallIsFalseImplementor() {
    super(null);
  }
  ...
  @Override Expression implementNotNull(final InnerVisitor translator,
    ...
    return Expressions.equal(argValueList.get(0), RexCallImpTable.FALSE_EXPR);
  }
}

// End RexCallIsFalseImplementor.java
