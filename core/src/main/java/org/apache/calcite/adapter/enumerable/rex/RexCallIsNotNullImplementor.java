...
class RexCallIsNotNullImplementor extends RexCallAbstractImplementor {

  RexCallIsNotNullImplementor() {
    super(null, false);
  }
  ...
  @Override Expression implementNotNull(final InnerVisitor translator,
    ...
    return Expressions.notEqual(argValueList.get(0), RexCallImpTable.NULL_EXPR);
  }
}

// End RexCallIsNotNullImplementor.java
