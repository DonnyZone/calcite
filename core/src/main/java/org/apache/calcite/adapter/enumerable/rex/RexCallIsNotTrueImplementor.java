...
class RexCallIsNotTrueImplementor extends RexCallAbstractImplementor {

  RexCallIsNotTrueImplementor() {
    super(null, false);
  }
  ...
  @Override Expression implementNotNull(final InnerVisitor translator,
    ...
    return Expressions.notEqual(argValueList.get(0), RexCallImpTable.TRUE_EXPR);
  }
}

// End RexCallIsNotTrueImplementor.java
