...
class RexCallIsNullImplementor extends RexCallAbstractImplementor {

  RexCallIsNullImplementor() {
    super(null);
  }
  ...
  @Override Expression implementNotNull(final InnerVisitor translator,
    ...
    return Expressions.equal(argValueList.get(0), RexCallImpTable.NULL_EXPR);
  }
}
